...
if(isset($_POST['submit_report'])){
   ...
   mysqli_query($conn,"INSERT INTO `reports`(sender_type,sender_id,sender_name,subject,message) VALUES('waiter','$wid','$wname','$subject','$msg')");
   $message[] = 'Report submitted to admin!';
}

$my_reports = mysqli_query($conn,"SELECT * FROM `reports` WHERE sender_type='waiter' AND sender_id='$wid' ORDER BY created_at DESC");
?>
<!DOCTYPE html>
<html lang="en">
<head>
   ...
   <title>Report Issue - Spice Garden</title>
   ...
   <div class="form-container" style="margin-bottom:3rem;">
      ...
      <form method="post">
         <div class="form-group">
            ...
            <input type="text" value="<?php echo $wname; ?>" readonly style="width:100%;padding:1rem;background:#f8f9ff;color:#9ca3af;border:1.5px solid #e8eaf6;border-radius:.9rem;font-size:1.5rem;">
         </div>
         <div class="form-group">
            <label>Subject</label>
         ...
         <div class="form-group">
            <label>Message</label>
            <textarea name="message" placeholder="Describe the issue in detail..." required style="width:100%;padding:1rem;background:#f8f9ff;color:#1a1a2e;border:1.5px solid #e8eaf6;border-radius:.9rem;font-size:1.5rem;padding:1.1rem 1.5rem;font-family:'Plus Jakarta Sans',sans-serif;min-height:12rem;resize:vertical;"></textarea>
         </div>
